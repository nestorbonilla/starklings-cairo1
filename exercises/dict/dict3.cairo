...
impl TeamImpl of TeamTrait {
    ...
    fn get_level(ref self: Team, name: felt252) -> usize { //TODO 
        self.level.get(name)
    }

    fn add_player(ref self: Team, name: felt252, level: usize) -> () { //TODO
        self.level.insert(name, level);
        self.players_count += 1;
    }

    fn level_up(ref self: Team, name: felt252) { //TODO
